...
from utils.utils import print_error, print_debug
from exceptions.TaskInterrupt import TaskInterrupt
...
class Task(ABC, threading.Thread):
    ...
    It is used by the :py:class:`~core.tools.Tool` class and the
    :py:class:`~core.api.Api` class.
    """
    ...
    def run(self):
        ...
        :py:class:`~core.exceptions.TaskInterrupt` for more details).
        """
    ...
    def interrupt(self):
        ...
        This method throws a :py:class:`~core.exceptions.TaskInterrupt`
